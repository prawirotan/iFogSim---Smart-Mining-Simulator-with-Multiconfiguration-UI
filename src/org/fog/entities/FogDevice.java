...
public class FogDevice extends PowerDatacenter {
	...
	protected Map<String, ApplicationFog> applicationMap;
	...
	public FogDevice(
		...
		applicationMap = new HashMap<String, ApplicationFog>();
			...
			for (Vm vm : host.getVmList()) {
				while (vm.getCloudletScheduler().isFinishedCloudlets()) {
					...
					if (cl != null) {
						...
						ApplicationFog application = getApplicationMap().get(tuple.getAppId());
	...
	protected void updateTimingsOnReceipt(Tuple tuple) {
		ApplicationFog app = getApplicationMap().get(tuple.getAppId());
	...
	private void initializePeriodicTuples(AppModule module) {
		String appId = module.getAppId();
		ApplicationFog app = getApplicationMap().get(appId);
	...
	public Map<String, ApplicationFog> getApplicationMap() {
		return applicationMap;
	}

	public void setApplicationMap(Map<String, ApplicationFog> applicationMap) {
