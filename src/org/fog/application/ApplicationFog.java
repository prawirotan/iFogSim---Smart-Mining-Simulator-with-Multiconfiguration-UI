...
public class ApplicationFog {
	 ...
	 * @return
	 */
	public static ApplicationFog createApplication(String appId, int userId){
		return new ApplicationFog(appId, userId);
	}
	...
	public ApplicationFog(String appId, int userId) {
		setAppId(appId);
		setUserId(userId);
	...
	public ApplicationFog(String appId, List<AppModule> modules,
