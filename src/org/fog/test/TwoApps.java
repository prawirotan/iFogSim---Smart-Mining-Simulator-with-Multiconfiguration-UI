...
public class TwoApps {
	...
	public static void main(String[] args) {
		...
		try {
			...
			ApplicationFog application0 = createApplication0(appId0, broker0.getId());
			ApplicationFog application1 = createApplication1(appId1, broker1.getId());
...
*/		return mobile;
	...
	private static ApplicationFog createApplication0(String appId, int userId){
		
		ApplicationFog application = ApplicationFog.createApplication(appId, userId); // creates an empty application model (empty directed graph)
	...
	@SuppressWarnings({"serial" })
	private static ApplicationFog createApplication1(String appId, int userId){
